            ...
            <div class="row justify-content-center">
                    ...
                    <div class="ticy-product">
                        <div class="product-thumbnail-wrapper">
                            <div class="single-thumbnail-slider">
                                ...
                                <div class="slider-item">
                                    <img src="https://themefie.com/html/foodka/assets/img/product/burger/1.png" alt="item">
                                </div>
                                <div class="slider-item">
                                    <img src="https://themefie.com/html/foodka/assets/img/product/pizza/1.png" alt="item">
                                </div> -->
                ...
                <div class="col-md-6">
                    <div class="shop-item-details">
                        ...
                        <hr>
                        <div>
                            <h3 class="entry-title">Nutritional Info.</h3>
                            <div class="progress">
                        ...
                        <p class="mt-4">Pizza is a savory dish of Italian origin consisting of a usually round.</p>
                    </div>
                </div>
            </div>
        </div>
